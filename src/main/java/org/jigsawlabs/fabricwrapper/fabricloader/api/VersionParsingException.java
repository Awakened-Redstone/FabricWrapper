...
package org.jigsawlabs.fabricwrapper.fabricloader.api;

@SuppressWarnings("deprecation") //Extending the deprecated one for backwards compatibility
public class VersionParsingException extends org.jigsawlabs.fabricwrapper.fabricloader.util.VersionParsingException {
