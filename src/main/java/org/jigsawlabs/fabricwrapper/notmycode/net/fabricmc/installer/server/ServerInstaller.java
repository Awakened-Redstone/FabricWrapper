...
public class ServerInstaller {
    ...
    public static void install(File dir, String loaderVersion, String gameVersion, InstallerProgress progress) throws IOException {
        ...
        {
            URL profileUrl0 = ServerInstaller.class.getClassLoader().getResource("libraries.json");
            Json json0 = Json.read(Utils.readTextFile(profileUrl0));

            for (Json libraryJson : json0.at("libraries").asJsonList()) {
                Library library = new Library(libraryJson);
